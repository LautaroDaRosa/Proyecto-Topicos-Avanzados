...
INSERT INTO user (email, info, name, password, phone, role)
VALUES ('provider2@example.com', 'Provider 2 Info', 'Provider 2', '48690', '48690', 'PROVIDER');

INSERT INTO user (email, info, name, password, phone, role)
VALUES ('provider3@example.com', 'Provider 3 Info', 'Provider 3', '48690', '48690', 'PROVIDER');
...
INSERT INTO provider (address, business_name, contact, logo, rut, social_environmental, social_governance, social_score, user_id, form_form_id, average_score)
VALUES ('Paraguay, 2253, Montevideo, Uruguay', 'CANAL 4 S.A.', '', 'https://upload.wikimedia.org/wikipedia/commons/3/33/Canal4_uy.png', '633334234363643', 0, 0, 6, 2, null, null);

INSERT INTO provider (address, business_name, contact, logo, rut, social_environmental, social_governance, social_score, user_id, form_form_id, average_score)
VALUES ('Enriqueta Compte y Riqué 1276', 'TELEDOCE S.A.', '', 'https://upload.wikimedia.org/wikipedia/commons/7/79/Teledoce_2022.png', '3457385937529', 0, 0, 7, 3, null, null);

-- Crear registros de ejemplo en la tabla `Category` para los proveedores
INSERT INTO category (category, provider_user_id) VALUES (0, 1);
INSERT INTO category (category, provider_user_id) VALUES (0, 2);
INSERT INTO category (category, provider_user_id) VALUES (0, 3);
...
-- Otras relaciones y datos que desees crear para los socios
